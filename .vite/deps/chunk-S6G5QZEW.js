...
var ICONS = {
  add: async () => (await import("./add-BXEO3FX3.js")).addSvg,
  allWallets: async () => (await import("./all-wallets-VNBQ3GGH.js")).allWalletsSvg,
  arrowBottomCircle: async () => (await import("./arrow-bottom-circle-DLYCI4FZ.js")).arrowBottomCircleSvg,
  appStore: async () => (await import("./app-store-JF5MMUVM.js")).appStoreSvg,
  apple: async () => (await import("./apple-YMPORFKY.js")).appleSvg,
  arrowBottom: async () => (await import("./arrow-bottom-HVXWAQ6R.js")).arrowBottomSvg,
  arrowLeft: async () => (await import("./arrow-left-S5R67JNF.js")).arrowLeftSvg,
  arrowRight: async () => (await import("./arrow-right-SKW5G6GM.js")).arrowRightSvg,
  arrowTop: async () => (await import("./arrow-top-HDE3ZE52.js")).arrowTopSvg,
  bank: async () => (await import("./bank-UN6SSQGG.js")).bankSvg,
  browser: async () => (await import("./browser-UTHRNHXQ.js")).browserSvg,
  card: async () => (await import("./card-AD4B4E47.js")).cardSvg,
  checkmark: async () => (await import("./checkmark-AAFWMPSJ.js")).checkmarkSvg,
  checkmarkBold: async () => (await import("./checkmark-bold-V2U2IHM4.js")).checkmarkBoldSvg,
  chevronBottom: async () => (await import("./chevron-bottom-LQKV24KV.js")).chevronBottomSvg,
  chevronLeft: async () => (await import("./chevron-left-NEICTADV.js")).chevronLeftSvg,
  chevronRight: async () => (await import("./chevron-right-LUEEZPQX.js")).chevronRightSvg,
  chevronTop: async () => (await import("./chevron-top-GQXIHO4G.js")).chevronTopSvg,
  chromeStore: async () => (await import("./chrome-store-XYBVGYA3.js")).chromeStoreSvg,
  clock: async () => (await import("./clock-5TPVQDL6.js")).clockSvg,
  close: async () => (await import("./close-ZAK3ABFY.js")).closeSvg,
  compass: async () => (await import("./compass-OC6DN5EV.js")).compassSvg,
  coinPlaceholder: async () => (await import("./coinPlaceholder-GYYLAPNZ.js")).coinPlaceholderSvg,
  copy: async () => (await import("./copy-G7IDAJKZ.js")).copySvg,
  cursor: async () => (await import("./cursor-PRLP4W75.js")).cursorSvg,
  cursorTransparent: async () => (await import("./cursor-transparent-X5XVR5NZ.js")).cursorTransparentSvg,
  desktop: async () => (await import("./desktop-LY2OWQUN.js")).desktopSvg,
  disconnect: async () => (await import("./disconnect-PMNCP3VW.js")).disconnectSvg,
  discord: async () => (await import("./discord-RFMZXT4L.js")).discordSvg,
  etherscan: async () => (await import("./etherscan-XRDRLSND.js")).etherscanSvg,
  extension: async () => (await import("./extension-BNVLHGTK.js")).extensionSvg,
  externalLink: async () => (await import("./external-link-UW6TTSBG.js")).externalLinkSvg,
  facebook: async () => (await import("./facebook-APK6JEJ5.js")).facebookSvg,
  farcaster: async () => (await import("./farcaster-6U6EDYWE.js")).farcasterSvg,
  filters: async () => (await import("./filters-YID6IDCQ.js")).filtersSvg,
  github: async () => (await import("./github-MEGD477R.js")).githubSvg,
  google: async () => (await import("./google-IFZG3UJT.js")).googleSvg,
  helpCircle: async () => (await import("./help-circle-QPQSV2ME.js")).helpCircleSvg,
  image: async () => (await import("./image-YNPDL5GZ.js")).imageSvg,
  id: async () => (await import("./id-D5Z4DP4W.js")).idSvg,
  infoCircle: async () => (await import("./info-circle-5TZRGJCZ.js")).infoCircleSvg,
  lightbulb: async () => (await import("./lightbulb-LF5ISRG5.js")).lightbulbSvg,
  mail: async () => (await import("./mail-CBJDVYTW.js")).mailSvg,
  mobile: async () => (await import("./mobile-P4QAKHXU.js")).mobileSvg,
  more: async () => (await import("./more-WXHRTQ4E.js")).moreSvg,
  networkPlaceholder: async () => (await import("./network-placeholder-UXIDVPBG.js")).networkPlaceholderSvg,
  nftPlaceholder: async () => (await import("./nftPlaceholder-3S7XKGYZ.js")).nftPlaceholderSvg,
  off: async () => (await import("./off-RPIJ5FYY.js")).offSvg,
  playStore: async () => (await import("./play-store-D52YPKEA.js")).playStoreSvg,
  plus: async () => (await import("./plus-KCSJCTPZ.js")).plusSvg,
  qrCode: async () => (await import("./qr-code-ECXUMVHH.js")).qrCodeIcon,
  recycleHorizontal: async () => (await import("./recycle-horizontal-FYJ4NWAA.js")).recycleHorizontalSvg,
  refresh: async () => (await import("./refresh-H4B2AFZZ.js")).refreshSvg,
  search: async () => (await import("./search-LWSG5E6T.js")).searchSvg,
  send: async () => (await import("./send-F7AXS2SJ.js")).sendSvg,
  swapHorizontal: async () => (await import("./swapHorizontal-I7F6LNSA.js")).swapHorizontalSvg,
  swapHorizontalMedium: async () => (await import("./swapHorizontalMedium-YG7P6N3T.js")).swapHorizontalMediumSvg,
  swapHorizontalBold: async () => (await import("./swapHorizontalBold-FATLYBLE.js")).swapHorizontalBoldSvg,
  swapHorizontalRoundedBold: async () => (await import("./swapHorizontalRoundedBold-6KZPJDNX.js")).swapHorizontalRoundedBoldSvg,
  swapVertical: async () => (await import("./swapVertical-BBYROV2R.js")).swapVerticalSvg,
  telegram: async () => (await import("./telegram-2DINUWNE.js")).telegramSvg,
  threeDots: async () => (await import("./three-dots-MAX3ZUE4.js")).threeDotsSvg,
  twitch: async () => (await import("./twitch-O73CJDWF.js")).twitchSvg,
  twitter: async () => (await import("./x-4WC2KLHL.js")).xSvg,
  twitterIcon: async () => (await import("./twitterIcon-GD3FC7NO.js")).twitterIconSvg,
  verify: async () => (await import("./verify-WRDVDIHC.js")).verifySvg,
  verifyFilled: async () => (await import("./verify-filled-DWPOWARD.js")).verifyFilledSvg,
  wallet: async () => (await import("./wallet-3URBG4KZ.js")).walletSvg,
  walletConnect: async () => (await import("./walletconnect-UQ2KSIK5.js")).walletConnectSvg,
  walletConnectLightBrown: async () => (await import("./walletconnect-UQ2KSIK5.js")).walletConnectLightBrownSvg,
  walletConnectBrown: async () => (await import("./walletconnect-UQ2KSIK5.js")).walletConnectBrownSvg,
  walletPlaceholder: async () => (await import("./wallet-placeholder-C3CQVEJY.js")).walletPlaceholderSvg,
  warningCircle: async () => (await import("./warning-circle-LE4D37EW.js")).warningCircleSvg,
  x: async () => (await import("./x-4WC2KLHL.js")).xSvg,
  info: async () => (await import("./info-JPUZZUNN.js")).infoSvg,
  exclamationTriangle: async () => (await import("./exclamation-triangle-JVJ5GZAB.js")).exclamationTriangleSvg,
  reown: async () => (await import("./reown-logo-CGQAKIJ6.js")).reownSvg
};
...
lit-html/development/directive-helpers.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-S6G5QZEW.js.map
